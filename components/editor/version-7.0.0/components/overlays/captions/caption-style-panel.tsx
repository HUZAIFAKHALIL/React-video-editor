...
import { CaptionAnimationPanel } from "./caption-animation-panel";
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <ToggleGroup
                  ...
                  onValueChange={(value) => {
                    if (value) handleStyleChange("textAlign", value as "left" | "center" | "right");
                  }}
                >
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2">
                  <Slider
                    value={[
                      Number.parseFloat(
                        localOverlay.styles?.wordSpacing?.replace(/[a-z]/g, "") ||
                          "0"
                      ),
                    ]}
                    onValueChange={([value]) =>
                      handleStyleChange("wordSpacing", `${value}em`)
                    }
                    min={-0.1}
                    max={1}
                    step={0.01}
                  ...
                  />
                  <span className="text-xs text-muted-foreground w-12">
                    {localOverlay.styles?.wordSpacing || "0em"}
                  </span>
                </div>
              </div>
